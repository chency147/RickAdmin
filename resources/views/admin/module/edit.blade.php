			...
			<div class="widget am-cf">
				...
				<div class="widget-body am-fr">
					<form class="am-form tpl-form-line-form">
						<input type="hidden" name="origin_code" value="{{ $module->code }}"/>
						<div class="am-form-group">
							<label for="module-name" class="am-u-sm-3 am-form-label">模块名称 <span
										class="tpl-form-line-small-title">Name</span></label>
							<div class="am-u-sm-9">
								<input type="text" class="tpl-form-input" id="module-name" placeholder="请输入模块名称"
									   maxlength="10" value="{{ $module->name }}"/>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" class="tpl-form-input" id="module-code" placeholder="请输入模块编码"
									   maxlength="64" value="{{ $module->code }}"/>
								<small>模块编码，唯一，采用大驼峰英语词组，最多64个字母。</small>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" class="tpl-form-input" id="module-icon" placeholder="请输入模块图标类名"
									   maxlength="32" value="{{ $module->icon }}"/>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-2">
								<input type="number" class="tpl-form-input" id="module-icon" placeholder="排序值"
									   maxlength="32" value="{{ $module->sort }}"/>
							...
							<div class="am-u-sm-9">
								<div class="tpl-switch">
									<input type="checkbox" class="ios-switch bigswitch tpl-switch-btn"
										   @if($module->is_show) checked="" @endif/>
